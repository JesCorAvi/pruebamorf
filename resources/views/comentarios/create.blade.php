<x-app-layout>
    ...
    <form action="{{ route('comentarios.store') }}" class="max-w-sm mx-auto" method="POST" >
        @csrf
        <div class="mb-5">
            <label for="nombre" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Escriba su comentario</label>
            <textarea type="text" name="comentario" id="contenido"
